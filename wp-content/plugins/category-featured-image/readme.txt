...
* If you want to exclude batch changes by category from some posts, you can set it.
...
3. Settings
4. Column view for apply or exclude bulk changes
5. Quick edit for apply or exclude bulk changes
